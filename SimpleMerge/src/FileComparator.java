...
public class FileComparator {
	...
	/**
	 * Reading out a LCS
	 *	backtracking을 이용하여 C의 배열을 연산한다. 
	 *	접두사의 마지막 문자들이 같으면, 원래의 LCS에 그 문자를 더한 String을 return
	 *	접두사의 마지막 문자들이 다르면, 가장 큰 LCS를 return
	 */
	 ...
	 * 	text1과 text2가 같은 길이의 결과를 return 한다면,
	 *	결과로 나오는 모든 subsequences를 읽어들인다
	 * 
	 */
